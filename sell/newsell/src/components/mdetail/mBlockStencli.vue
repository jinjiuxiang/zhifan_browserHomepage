  ...
  <div class="m-stencli-container">
      <div class="m-stencli-header">
        ...
        <div class="m-stencli-info">
          ...
          <span class="m-stencli-info-res">000000000bbc38f95628b32027c38ae643c338a08f9ad7ecca345aaf30313292</span>
        </div>
      </div>
      <div class="m-stencli-main">
        <div class="m-stencli-info">
          <span class="m-stencli-info-label">区块高度：</span>
          <span class="m-stencli-info-desc">533560</span>
        </div>
        <div class="m-stencli-info">
          <span class="m-stencli-info-label">总交易数：</span>
          <span class="m-stencli-info-desc">100</span>
        </div>
        <div class="m-stencli-info">
          <span class="m-stencli-info-label">总输出：</span>
          <span class="m-stencli-info-desc">100&nbsp;BTC</span>
        </div>
        <div class="m-stencli-info">
          <span class="m-stencli-info-label">时间：</span>
          <span class="m-stencli-info-desc">2018.08.24  16:01:17</span>
        </div>
        <div class="m-stencli-info">
          <span class="m-stencli-info-label"></span>
          <span class="m-stencli-info-detail"><span>查看详情</span></span>
        </div>
      </div>
  </div>
</template>
